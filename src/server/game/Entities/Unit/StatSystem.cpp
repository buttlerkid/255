...
void Player::UpdateCritPercentage(WeaponAttackType attType)
{
    ...
    value = value < 0.0f ? 0.0f : value;
    SetStatFloatValue(index, value*0.50f);
}
...
void Player::UpdateAllCritPercentages()
{
    ...
    SetBaseModValue(CRIT_PERCENTAGE, PCT_MOD, value*0.50f);
    SetBaseModValue(OFFHAND_CRIT_PERCENTAGE, PCT_MOD, value*0.50f);
    SetBaseModValue(RANGED_CRIT_PERCENTAGE, PCT_MOD, value*0.50f);
...
void Player::UpdateDodgePercentage()
{
    ...
    value = value < 0.0f ? 0.0f : value;
    SetStatFloatValue(PLAYER_DODGE_PERCENTAGE, value*0.50f);
}
...
void Player::UpdateSpellCritChance(uint32 school)
{
    ...
    // Store crit value
    SetFloatValue(PLAYER_SPELL_CRIT_PERCENTAGE1 + school, crit*0.50f);
}
